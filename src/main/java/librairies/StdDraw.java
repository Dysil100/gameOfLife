package librairies;
/******************************************************************************
 *  Compilation:  javac librairies.StdDraw.java
 *  Execution:    java librairies.StdDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code librairies.StdDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code librairies.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">librairies.StdDraw.java</a>
 ...
 *           librairies.StdDraw.setPenRadius(0.05);
 *           librairies.StdDraw.setPenColor(librairies.StdDraw.BLUE);
 *           librairies.StdDraw.point(0.5, 0.5);
 *           librairies.StdDraw.setPenColor(librairies.StdDraw.MAGENTA);
 *           librairies.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code librairies.StdDraw.line()} and {@code librairies.StdDraw.point()}
 *  draw lines and points; the methods {@code librairies.StdDraw.setPenRadius()}
 *  and {@code librairies.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code librairies.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   librairies.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code librairies.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code librairies.StdDraw.setPenColor(librairies.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code librairies.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code librairies.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   librairies.StdDraw.setFont(font);
 *   librairies.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code librairies.StdDraw.clear(librairies.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   librairies.StdDraw.setScale(-2, +2);
 *   librairies.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       librairies.StdDraw.clear();
 *       librairies.StdDraw.filledCircle(x, y, 0.05);
 *       librairies.StdDraw.filledCircle(-x, -y, 0.05);
 *       librairies.StdDraw.show();
 *       librairies.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * {@code librairies.StdDraw.BLACK}, {@code librairies.StdDraw.BLUE}, {@code librairies.StdDraw.CYAN},
     * {@code librairies.StdDraw.DARK_GRAY}, {@code librairies.StdDraw.GRAY}, {@code librairies.StdDraw.GREEN},
     * {@code librairies.StdDraw.LIGHT_GRAY}, {@code librairies.StdDraw.MAGENTA}, {@code librairies.StdDraw.ORANGE},
     * {@code librairies.StdDraw.PINK}, {@code librairies.StdDraw.RED}, {@code librairies.StdDraw.WHITE}, and
     * {@code librairies.StdDraw.YELLOW}.
     *
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to librairies.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to librairies.StdDraw)
        try {
            URL url = librairies.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        } 
        catch (IOException e) {
